   ...
   $correct3 = 0;
    ...
    function divRand() {
         ...
         $output1 = "<div class='col-md-3'>
                 ...
                 <span class='dot' style='background-color:rgb(".randNum().","
                 .randNum().","
                 .randNum().");'></span>
        ...
        $output3 = "<div class='col-md-3'>
                 ...
                 <span class='dot' style='background-color:rgb(" 
                 .$correct1.","
                 .$correct2.","
                 .$correct3.");'></span>
                </div>";
       ...
       $divs = array($output1,$output2,$output3,$output4,$output5,$output6);//divs inserted to the array
