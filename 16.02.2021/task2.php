          ...
          function sahmat_cek(){
            ...
            echo "<thead>";
              echo "<tr>";//the black line for the top part border of the chessboard
                 ...
                 for ( $k = 1 ; $k <= 8 ; $k++ ) {//iterating every row
                 echo "<td height=4px bgcolor=#312e2b></td>";
                 }
                 echo "<td height=4px bgcolor=#312e2b></td>";
              echo "</tr>";
            ...
            for( $i = 1 ; $i <= 8 ; $i++ ) {//row for the table
               echo "<tr>";
               for ( $j = 0 ; $j <= 8; $j++ ) {//column for the table
               $toplam = $i + $j;
               if ( $toplam %2 == 0 && $j != 0){
            ...
            if ( $j == 8 ){    //right side border of the chessboard
                echo "<td  width=10px bgcolor=#312e2b></td>";
            } else if ( $j == 0 ){//read line 23
